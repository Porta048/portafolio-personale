...
function initWoodenWindowModal() {
    ...
    function openModal() {
        ...
        if (photoFrame) tl.to(photoFrame, {
            opacity: 1,
            y: 0,
            duration: 0.6,
            ease: 'bounce.out'
        ...
        if (windowInfo) tl.to(windowInfo, {
            opacity: 1,
            y: 0,
            duration: 0.5,
            ease: 'power2.out'
        ...
        if (stats && stats.length > 0) tl.to(stats, {
            opacity: 1,
            y: 0,
            scale: 1,
            duration: 0.5,
        ...
        if (timelineItems && timelineItems.length > 0) tl.to(timelineItems, {
            opacity: 1,
            y: 0,
            duration: 0.5,
            ease: 'power2.out',
        ...
        if (windowButtons) tl.to(windowButtons, {
            opacity: 1,
            y: 0,
            duration: 0.5,
            ease: 'bounce.out'
    ...
    function preventBackgroundScroll(e) {
        ...
        if (modalContent && modalContent.contains(target)) return; // Don't prevent scrolling inside modal
        // Prevent scrolling on background
        e.preventDefault();
    }
    function animateModalStats() {
        const statNumbers = modal?.querySelectorAll('.stat h4');
        statNumbers?.forEach((stat, index)=>{
            const target = parseInt(stat.dataset.target || '0', 10);
            const suffix = stat.dataset.suffix || '';
            // Animate with GSAP for smoother counting
            (0, _gsap.gsap).fromTo(stat, {
                textContent: '0'
            }, {
                duration: 2,
                delay: index * 0.2,
    ...
    function addAboutButtonPulse() {
        if (aboutTrigger) (0, _gsap.gsap).to(aboutTrigger, {
            scale: 1.02,
            duration: 2,
            ease: 'power2.inOut',
            yoyo: true,
    ...
    const woodButtons = modal?.querySelectorAll('.wood-btn');
...
},{"@floating-ui/dom":"9ipqt","gsap":"9F7Z6"}],"9ipqt":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9F7Z6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"evdHe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["fsZiL","6NrYQ"], "6NrYQ", "parcelRequire2ffc", {})
